...
<body>
    ...
    <!-- <style>
        ...
        div.card {
            ...
            background: rgb(188, 208, 214) url(klematis.jpg) no-repeat center;
            ...
            border: solid 1px;
            box-shadow: 0px 4px 13px 4px rgba(192, 175, 175, 0.59) ;

        }

        div.card-header {
            font-weight: bold;
            background-color: rgb(119, 164, 176);
            text-decoration-color: aliceblue;
        }

        #costom-card-border-radius {
            border-radius: 15px !important;
        }

        #costom-card-header-border-radius {
