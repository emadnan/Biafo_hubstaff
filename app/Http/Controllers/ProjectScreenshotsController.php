...
class ProjectScreenshotsController extends Controller
{
    ...
    public function getProjectScreenshots(){
        $projectscreenshot= ProjectScreenshots::select('project_screenshots.*','project_screenshots.*','project_screenshots_timings.*','projects.*','projects.id as projects_id','project_screenshots_attachments.*','project_screenshots_attachments.id as project_screenshots_attachments_id')
